...
public class AdminController
{
	...
	public ModelAndView insertPolitician(HttpServletRequest request) {
	  ...
	  public ModelAndView viewpoliticans()
	  {
		  ModelAndView mv = new ModelAndView();
		  ...
		  long count = adminService.pcount();
	  ...
	  public ModelAndView deletepolitician()
	  {
		  ModelAndView mv = new ModelAndView();
		  List<Politician> plist = adminService.viewallpoliticians();
		  mv.setViewName("deletepolitician");
		  mv.addObject("plist", plist);
		  return mv;
	  }
	  
	  @GetMapping("delete")
	  public String deleteoperations(@RequestParam("id") int pid)
	  {
		  adminService.deletepolitician(pid);
		  return "redirect:/deletepolitician";
	  }
